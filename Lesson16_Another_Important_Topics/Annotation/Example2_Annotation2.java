...
public class Example2_Annotation2 {
    public static void main(String[] args) throws ClassNotFoundException {
        Class xiaomiClass = Class.forName("Lesson16_Another_Important_Topics.Annotation.Xiaomi");
       ...
       SmartPhone sm1 = (SmartPhone) annotation1;
        ...
        Class iphoneClass = Class.forName("Lesson16_Another_Important_Topics.Annotation.Iphone");
...
@interface SmartPhone{
    String OS() default "Android"; //Syntax of writing variables in @
